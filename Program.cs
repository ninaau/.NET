...
/*IList<string> orderByList (IList<string> list)
        {
            var orderedWords = from w in list
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                switch (option)
                {
                    ...
                    case 3:
                        stopWatch.Start();
                        var lamSort = (from w in p.wordsList
                                       orderby w.Length ascending
                                       select w).ToList();
                        foreach (String s in lamSort)
                        {
                            Console.WriteLine("\n" + s);
                        }
                        stopWatch.Stop();
                        TimeSpan t = stopWatch.Elapsed;
                        Console.WriteLine("Time elapsed : " + t.Milliseconds / 10 + "ms");
                        break;
                    case 4:
