...
namespace Ass2NET.Controllers
{
    public class CommunitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentsId,Title,Budget")] Community community)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("StudentsId,Title,Budget")] Community community)
        {
