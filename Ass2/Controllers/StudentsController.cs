...
namespace Ass2NET.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string Id)
        {
            ...
            if (Id != null)
            {
                ...
                viewModel.CommunityMemberships = viewModel.Students.Where(
                    x => x.StudentId.ToString() == Id).Single().CommunityMemberships;
            }
        ...
        public async Task<IActionResult> Create([Bind("StudentsId,LastName,FirstName,EnrollmentDate")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentsId,LastName,FirstName,EnrollmentDate")] Student student)
        {
